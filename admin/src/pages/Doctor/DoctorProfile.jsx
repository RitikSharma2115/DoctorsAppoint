    ...
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {/* -------------Doc About------------- */}
          <div>
            <p className='items-center gap-1 text-sm font-medium text-neutral-800 mt-3'>About:</p>
          ...
          {
            isEdit
            ? <button onClick={updateProfile} className='text-lg px-4 py-1 border border-primary rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>Save</button>
            : <button onClick={()=>setIsEdit(true)} className='text-lg px-4 py-1 border border-primary rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>Edit</button>
          }
